...
export default defineComponent({
	setup() {
		...
		chartOption.xAxis.data = new Array(3).fill(1).map((e, i) => "套管"  + 1 + i);

		chartOption.series[0].data = new Array(3)
			.fill(2)
			.map(() => parseInt(String(Math.random() * 1000)));

		chartOption.series[1].data = new Array(3)
			.fill(2)
			.map(() => parseInt(String(Math.random() * 100)));

		chartOption.series[2].data = new Array(3)
			.fill(2)
			.map(() => parseInt(String(Math.random() * 10)));
		// chartOption.series[2].data = new Array(3).fill(100);
